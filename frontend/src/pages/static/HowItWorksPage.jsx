            ...
            <section className="bg-gray-50">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col items-center text-center max-w-md hover:shadow-lg transition">
                        ...
                        <h3 className="text-xl font-semibold mt-2 mb-2">PhotoSweep — Image Organizer for Windows</h3>
                        <p className="text-gray-600 mb-6">
                            Efficiently sort your photos and remove duplicates. Keep your image library organized and clutter-free.
                        </p>
                        <a 
